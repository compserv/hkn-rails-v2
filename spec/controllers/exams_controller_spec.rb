  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved exam as @exam" do
        ...
        post :create, {:exam => { "course_id" => "invalid value" }}, valid_session
        assigns(:exam).should be_a_new(Exam)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested exam" do
        ...
        Exam.any_instance.should_receive(:update).with({ "course_id" => "1" })
        put :update, {:id => exam.to_param, :exam => { "course_id" => "1" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the exam as @exam" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Exam.any_instance.stub(:save).and_return(false)
        put :update, {:id => exam.to_param, :exam => { "course_id" => "invalid value" }}, valid_session
        assigns(:exam).should eq(exam)
      end
