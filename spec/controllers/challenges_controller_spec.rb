...
describe ChallengesController do
  ...
  let(:valid_attributes) { { "requester_id" => "1" } }
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved challenge as @challenge" do
        ...
        post :create, {:challenge => { "requester_id" => "invalid value" }}, valid_session
        assigns(:challenge).should be_a_new(Challenge)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested challenge" do
        ...
        Challenge.any_instance.should_receive(:update).with({ "requester_id" => "1" })
        put :update, {:id => challenge.to_param, :challenge => { "requester_id" => "1" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the challenge as @challenge" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Challenge.any_instance.stub(:save).and_return(false)
        put :update, {:id => challenge.to_param, :challenge => { "requester_id" => "invalid value" }}, valid_session
        assigns(:challenge).should eq(challenge)
      end
